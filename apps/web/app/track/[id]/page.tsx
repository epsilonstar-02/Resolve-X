...
export default function TrackComplaint() {
  ...
  if (error) return (
    <main className="max-w-lg mx-auto mt-10 px-4 text-center">
      ...
      <a href="/" className="text-blue-700 text-sm mt-4 block hover:text-blue-900 hover:underline transition-colors">← Back to home</a>
    </main>
  );
  ...
  return (
    <main className="max-w-lg mx-auto px-4 py-8">
      ...
      <a href="/" className="text-sm text-blue-400 hover:text-blue-300 hover:underline transition-colors">← Back to home</a>
    </main>
  );
}